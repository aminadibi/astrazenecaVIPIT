...
abstract: |
  ...
  **Methods:** We reviewed the latest available evidence and used compartmental modelling to *1)* compare the expected number of deaths due to COVID-19 and VIPIT under the scenarios of immediately continuing vaccination of front-line workers with the AstraZeneca vaccine (Scenario A) or delaying it in favour of mRNA vaccines (Scenario B), and *2)* compare the mortality risk of immediately receiving the AstraZeneca vaccine and delaying vaccination at an individual risk level for different age groups. 
  
  **Results:** We estimate that if British Columbia continues the front-line worker vaccination program with the AstraZeneca vaccine, we expect to see approximately 27,000 fewer cases of COVID-19, 500 fewer hospitalizations, 80 fewer COVID-related deaths, and 1,400 fewer cases of Long COVID from April 1st to October 1st, 2021, for an expected number of VIPIT-related deaths of 0.674 [95% CI 0.414-0.997]. In areas of high transmission, projected excess risk of mortality per 100,000 due to COVID-19 and VIPIT-related death from April 1st to October 1st, 2021 was 2.4 under scenario A compared to 10.9 under Scenario B in 60-69, 1.13 under scenario A compared to 4.27 under scenario B in 50-59, 1.08 under scenario A compared to 4.05 under scenario B in 40-49 years old, 0.77 under scenario A compared to 2.49 under scenario B in 30-39 years old, and 0.27 under scenario A compared to 0 under scenario B for 20-29 years old age group.
...
\textsuperscript{a} EMA base values and $\beta$ distributions are based on a report of 18 deaths among 68 cases of VIPIT, and 222 cases of VIPIT among 34 million vaccine recipient in Europe and the UK. \\
...
Age  Group & Hospitalization & Death   & Long COVID & Vaccine Hesitancy & \% of Front-Line Workers \\ \hline
...
\end{tabular}}
\tabnote{Hospitalization, death, and Long COVID rates are number of people with the outcome divided by the number of concluded cases. Hospitalization and death rates for under 50 age groups are from BCCDC Situation Report Week 12, 2021. Death rates for age groups above 50 are from the preliminary dataset on confirmed cases of COVID-19, Public Health Agency of Canada (Tables: 13-26-0003) from January 1st, 2021 to April 9th, 2021 and accounts for the immunity already acquired in long-term care homes. Rates of Long COVID are Mulberry et al's estimations from data in Sudre et al. The proportion of essential workers by age was taken from the COVID Speak survey per Mulberry et al. }
\label{model-param}
\end{table}
...
```
Predicted epidemiological curve and age-stratified case counts showed good agreement with observed counts reported by BC CDC, except for the 80 and above age category where the model underestimated case counts (Figure 1), however, given that this age group had little implications on our results, no attempt was made to recalibrate the model for this age group.
...
ggplot(df, aes(y = Risk*100, x=age, fill=Scenario)) + geom_col(position = "dodge") +
       ...
       caption="Excess individual mortality risk due to COVID-19 and VIPIT from April 1st to October 1st, 2021,\n based on receiving two doses of any vaccine.") + facet_wrap(~R0, labeller=label_both) + 
