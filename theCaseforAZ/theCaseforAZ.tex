...
(VIPIT). As an example, we consider the province of British Columbia
(BC) which halted its front-line workers vaccination program which used
the AstraZeneca vaccine. The province received an additional 246,700
doses of AstraZeneca vaccine through US and COVAX in the weeks before
...
0.337 {[}95\% CI 0.207-0.495{]}, which means the probability of
...
0.41-0.988{]}. The probability of observing at least one VIPIT-related
