...
immunization of front-line workers with AstraZeneca vaccine far outweigh
the risk both at a societal level and at an individual risk level for
...
\(P(\text{death})_{\text{VIPIT}} = P(\text{vaccine}) \times P(\text{VIPIT}|\text{vaccine}) \times P(\text{death}|\text{VIPIT}, \text{vaccine})\),
...
0.336 {[}95\% CI 0.204-0.493{]}, which means the probability of
...
deaths until the end of summer is 0.675 {[}95\% CI 0.408-1{]}. The
probability of observing at least one VIPIT-related death till the end
of the summer will be 24.5\%, and the probability of observing two
