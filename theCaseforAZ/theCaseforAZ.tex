...
0.336 {[}95\% CI 0.207-0.501{]}, which means the probability of
observing at least one VIPIT-related death in the same period is 28.7\%.
Adding the risk from the second dose, the expected number of
VIPIT-related deaths until the end of summer is 0.674 {[}95\% CI
0.412-0.992{]}. The probability of observing at least one VIPIT-related
