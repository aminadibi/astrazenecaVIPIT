...
(VIPIT). As an example, we consider the Canadian province of British
Columbia (BC) which halted its front-line workers vaccination program
which used the AstraZeneca vaccine. The province received an additional
246,700 doses of AstraZeneca vaccine through US and COVAX in the weeks
before April 11th, enough to provide the first dose of vaccine to all
unvaccinated front-line workers. It is unclear whether the alternative,
...
outweigh the risk both at a societal level and at a personal risk level
for those over 40, and those over 30 in high-risk areas.
\end{abstract}

\begin{keywords}
COVID19; vaccination; front-line workers; blood clots; vaccine-induced
prothrombotic immune thrombocytopenia; harm-benefit; British Columbia
\end{keywords}
...
US and another 316,800 doses from the COVAX program between in the two
...
AZ vaccine (\emph{Scenario A}) and asking them to wait to receivemRNA
...
0.411-0.993{]}. The probability of observing at least one VIPIT-related
...
just under 2500 cases as of April 13th, 2021, when 61\% of the UK
