...
vaccine or delaying it in favour of mRNA vaccines, and \emph{2)} compare
the individual mortality risk of immediately receiving the AstraZeneca
vaccine and delayed vaccination with an mRNA vaccine for different age
groups.
...
0.337 {[}95\% CI 0.205-0.494{]}, which means the probability of
...
0.421-0.998{]}. The probability of observing at least one VIPIT-related
